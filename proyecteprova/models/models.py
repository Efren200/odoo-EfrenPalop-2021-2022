...
class player(models.Model):
    ...
    heroes = fields.One2many(string='Heroes', comodel_name='proyecteprova.hero', inverse_name='player')
    potions = fields.One2many(string='Potions', comodel_name='proyecteprova.potion', inverse_name='player')
    collector_buildings = fields.One2many(string='Collector Buildings', comodel_name='proyecteprova.collector_building', inverse_name='player')
    storage_buildings = fields.One2many(string='Storage Buildings', comodel_name='proyecteprova.storage_building', inverse_name='player')
    buildings = fields.One2many(string='Buildings', comodel_name='proyecteprova.building', inverse_name='player')
class hero(models.Model):
    _name = 'proyecteprova.hero'
    _description = "Hero"
    ...
    player = fields.Many2one(comodel_name='proyecteprova.player', ondelete='set null', help='Player who has the hero')

class potion(models.Model):
    _name = 'proyecteprova.potion'
    _description = "Potion"
    ...
    player = fields.Many2one(comodel_name='proyecteprova.player', ondelete='set null', help='Player who has the potion')

class collector_building(models.Model):
    _name = 'proyecteprova.collector_building'
    ...
    player = fields.Many2one(comodel_name='proyecteprova.player', ondelete='set null', help='Collector buildings that the player has')


class storage_building(models.Model):
    _name = 'proyecteprova.storage_building'
    ...
    capacity = fields.Integer(default=1000)
    price = fields.Integer(default=200)
    player = fields.Many2one(comodel_name='proyecteprova.player', ondelete='set null', help='Storage buildings that the player has')

class building(models.Model):
    _name = 'proyecteprova.building'
    _description = "Building"

    name = fields.Char(string="Name", readonly=False, required=True, help="Building name")
    level = fields.Integer(default=1)
    price = fields.Integer()
    player = fields.Many2one(comodel_name='proyecteprova.player', ondelete='set null', help='Buildings that the player has')
